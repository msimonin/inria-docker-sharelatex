...
#
# NOTE(INRIA): we set the custom left_footer

settings.nav.left_footer = [{
		text: "Powered by <a href=''>ShareLaTeX</a> © 2014"
	}, {
		text: "Deployed by <img src='/irisa/sed_logo.png' alt='SED'>"
	}, {
		text: "<a href='http://github.com/msimonin/sharelatex'><sharelatex_branch></a>"
	}]
#
#
...
# NOTE(INRIA): we set the custom left_footer
settings.nav.right_footer = [{
		text: "Support"
		url: "mailto:support-sharelatex@inria.fr"
	}]
...
#     http://www.nodemailer.com/docs/transports
	...
	# NOTE(INRIA): Using SMTP
	settings.email =
		fromAddress: "noreply@inria.fr"
		replyTo: "support-sharelatex@inria.fr"
		driver: "SMTP"
		parameters:
			#AWS Creds
...
# Compiler
# --------
# NOTE(INRIA): Compiling into our docker
settings.clsi =
	commandRunner: './DockerRunner'
	uid: <sharelatex_uid>
	gid: <sharelatex_gid>
	image: 'registry.gitlab.inria.fr/sed-rennes/sharelatex/inria-docker-sharelatex/clsi_worker:inria-1.2.1'
	timeout: 120
